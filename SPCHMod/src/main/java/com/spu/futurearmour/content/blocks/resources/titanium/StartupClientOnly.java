...
public class StartupClientOnly {
    ...
    {
        for (BlockState blockState : BlockRegistry.TITANIUM_ORE.get().getStateDefinition().getPossibleStates()) {
    ...
    public static void onClientSetupEvent(FMLClientSetupEvent event) {
        RenderTypeLookup.setRenderLayer(BlockRegistry.TITANIUM_ORE.get().getBlock(), RenderType.solid());
    }
