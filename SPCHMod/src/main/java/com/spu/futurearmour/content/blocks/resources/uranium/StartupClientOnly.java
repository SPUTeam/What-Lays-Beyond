...
public class StartupClientOnly {
    ...
    {
        for (BlockState blockState : BlockRegistry.URANIUM_ORE.get().getStateDefinition().getPossibleStates()) {
    ...
    public static void onClientSetupEvent(FMLClientSetupEvent event) {
        RenderTypeLookup.setRenderLayer(BlockRegistry.URANIUM_ORE.get().getBlock(), RenderType.solid());
    }
