...
public class UraniumOreBakedModel implements IBakedModel{
    ...
    public UraniumOreBakedModel(IBakedModel defaultModel)
    {
    ...
    public IModelData getModelData(@Nonnull IBlockDisplayReader world, @Nonnull BlockPos pos, @Nonnull BlockState state, @Nonnull IModelData tileData) {
        Optional<Boolean> shouldRender = UraniumOre.shouldRender(world, pos);
