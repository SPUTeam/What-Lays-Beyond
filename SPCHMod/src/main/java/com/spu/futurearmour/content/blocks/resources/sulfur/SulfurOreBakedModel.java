...
public class SulfurOreBakedModel implements IBakedModel{
    ...
    public SulfurOreBakedModel(IBakedModel defaultModel)
    {
    ...
    public IModelData getModelData(@Nonnull IBlockDisplayReader world, @Nonnull BlockPos pos, @Nonnull BlockState state, @Nonnull IModelData tileData) {
        Optional<Boolean> shouldRender = SulfurOre.shouldRender(world, pos);
