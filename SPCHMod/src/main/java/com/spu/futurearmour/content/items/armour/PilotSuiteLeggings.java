...
public class PilotSuiteLeggings extends SlotBlockingArmourItem implements LockableArmourItem {
    public PilotSuiteLeggings() {
        super(ModArmorMaterial.PILOT_SUIT, EquipmentSlotType.LEGS, new Properties()
                .tab(FutureArmour.ITEM_GROUP), EquipmentSlotType.FEET);
    }

    @Nullable
    @Override
    public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
        PilotCostumeCustomModel model = new PilotCostumeCustomModel(EquipmentSlotType.LEGS);
        return (A) model;
    }
