...
public class StartupClientOnly {
    ...
    {
        for (BlockState blockState : BlockRegistry.COPPER_ORE.get().getStateDefinition().getPossibleStates()) {
    ...
    public static void onClientSetupEvent(FMLClientSetupEvent event) {
        RenderTypeLookup.setRenderLayer(BlockRegistry.COPPER_ORE.get().getBlock(), RenderType.solid());
    }
