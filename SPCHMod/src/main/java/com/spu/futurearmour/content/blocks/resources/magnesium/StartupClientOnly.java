...
import com.spu.futurearmour.content.blocks.resources.aluminium.AluminiumOreBakedModel;
...
public class StartupClientOnly {
    ...
    {
        for (BlockState blockState : BlockRegistry.MAGNESIUM_ORE.get().getStateDefinition().getPossibleStates()) {
    ...
    public static void onClientSetupEvent(FMLClientSetupEvent event) {
        RenderTypeLookup.setRenderLayer(BlockRegistry.MAGNESIUM_ORE.get().getBlock(), RenderType.solid());
    }
