...
public class TitaniumOreBakedModel implements IBakedModel{
    ...
    public TitaniumOreBakedModel(IBakedModel defaultModel)
    {
    ...
    public IModelData getModelData(@Nonnull IBlockDisplayReader world, @Nonnull BlockPos pos, @Nonnull BlockState state, @Nonnull IModelData tileData) {
        Optional<Boolean> shouldRender = TitaniumOre.shouldRender(world, pos);
